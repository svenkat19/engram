...
from yonakh.mcp_server.server import mcp, _init, _stores
from yonakh.models.base import EntityType, ProvenanceAction, RelationType
from yonakh.models.entities import EntityCreate, EntityFilter
...
def remember(
    ...
    """Store knowledge in yonakh's memory. Use for architecture decisions, bug context, design rationale, failed attempts, or any engineering knowledge worth preserving."""
    _init()
    if title is None:
        title = content[:80]
...
def recall(
    ...
    """Search yonakh's memory for relevant knowledge. Returns semantically similar memories ranked by relevance and importance."""
    _init()
...
def find_contradictions(
    ...
    _init()
    from yonakh.quality.conflict import detect_conflicts
